...
public interface JavaLIB_OpenEpiCentre extends Library
{
    ...
    byte[] io_PRAISE_get_Item_Output_praise1_Value();
    byte[] io_PRAISE_get_Item_Output_praise2_Value();
    byte[] io_PRAISE_get_Item_Output_praise3_Value();
    byte[] io_RPRAISE_get_MetaData_PraiseEventId();
    void io_PRAISE_set_Item_Input_praise0_Value_A(byte[] bytes);
    void io_PRAISE_set_Item_Input_praise0_Value_B(byte[] bytes);
    void io_PRAISE_set_Item_Input_praise1_Value_A(byte[] bytes);
    void io_PRAISE_set_Item_Input_praise1_Value_B(byte[] bytes);
    void io_PRAISE_set_Item_Input_praise2_Value_A(byte[] bytes);
    void io_PRAISE_set_Item_Input_praise2_Value_B(byte[] bytes);
    void io_PRAISE_set_Item_Input_praise3_Value_A(byte[] bytes);
    void io_PRAISE_set_Item_Input_praise3_Value_B(byte[] bytes);
    void io_PRAISE_set_MetaData_PraiseEventId(byte[] bytes);
}