...
void* OpenAvrilCLIBWriteEnableForThreadsAtSERVERINPUTACTION::CLIBWriteEnableForThreadsAtSERVERINPUTACTION::app_FUNCT_generate_Program()
{
	...
	std::cout << "started Program - INSTANTIATION." << std::endl;
	stat_CLASS_get_ptr_Framework()->boot4_PGM_INSTANTIATION_WriteEnableForThreadsAt_SERVERINPUTACTION_Framework(stat_CLASS_get_ptr_Framework());
	std::cout << "done Program - INSTANTIATION." << std::endl;
...
##### Header.
````
fdef LIBWRITEENABLEFORTHREADSATSERVEROUTPUTRECIEVE_EXPORTS
...
void* OpenAvrilCLIBWriteEnableForThreadsAtSERVEROUTPUTRECIEVE::CLIBWriteEnableForThreadsAtSERVEROUTPUTRECIEVE::app_FUNCT_generate_Program()
{
	...
	std::cout << "started Program - INSTANTIATION." << std::endl;
	stat_CLASS_get_ptr_Framework()->boot4_PGM_INSTANTIATION_WriteEnableForThreadsAt_SERVEROUTPUTRECIEVE_Framework(stat_CLASS_get_ptr_Framework());
	std::cout << "done Program - INSTANTIATION." << std::endl;
...
extern "C"
{
	namespace OpenAvrilConcurrency
	{
		...
		public:
			...
			static void* app_FUNCT_generate_Program();
			static bool app_FUNCT_get_CLIBConcurrentServerIO_flag_isPGM_INSTNATIATED();
			...
			static unsigned char* io_PRAISE_get_Item_Output_praise0_Value(void* obj);
			static unsigned char* io_RPRAISE_get_ptr_PraiseEventId(void* obj);
			static void io_PRAISE_set_Item_Input_praise0_Value_A(void* obj, unsigned char* bytes);
			static void io_PRAISE_set_Item_Input_praise0_Value_B(void* obj, unsigned char* bytes);
			static void io_PRAISE_set_PraiseEventId(void* obj, unsigned char* bytes);
		private:
			static void stat_app_FUNCT_Calc_IsAllINSTANTIATED();
...
#include "LIB_Concurrent_IO_Server.h"
	class OpenAvrilConcurrency::Framework_Server* _CLASS_ptr_Framework_Server;
...
// public.
	...
	bool OpenAvrilConcurrency::CLIBConcurrentServerIO::app_FUNCT_get_CLIBConcurrentServerIO_flag_isPGM_INSTNATIATED()
	{
		if (stat_REG_get_ptr_flag_isMemberFunctionINSTANTIATED()[2] == false) {
			return stat_REG_get_ptr_flag_isMemberFunctionINSTANTIATED()[0];
		}
	...
	unsigned char* OpenAvrilConcurrency::CLIBConcurrentServerIO::io_PRAISE_get_Item_Output_praise0_Value(void* obj)
	{
	...
	unsigned char* OpenAvrilConcurrency::CLIBConcurrentServerIO::io_RPRAISE_get_ptr_PraiseEventId(void* obj)
	{
	...
	void OpenAvrilConcurrency::CLIBConcurrentServerIO::io_PRAISE_set_Item_Input_praise0_Value_A(void* obj, unsigned char* bytes)
	{
	...
	void OpenAvrilConcurrency::CLIBConcurrentServerIO::io_PRAISE_set_Item_Input_praise0_Value_B(void* obj, unsigned char* bytes)
	{
	...
	void OpenAvrilConcurrency::CLIBConcurrentServerIO::io_PRAISE_set_PraiseEventId(void* obj, unsigned char* bytes)
	{
...
// private.
	...
	{
		_stat_REG_get_flag_isMemberFunctionINSTANTIATED = new bool[17]();
		while (stat_REG_get_ptr_flag_isMemberFunctionINSTANTIATED() == NULL) {}
		for (uint8_t index = 0; index < sizeof(*stat_REG_get_ptr_flag_isMemberFunctionINSTANTIATED()); index++)
		{
