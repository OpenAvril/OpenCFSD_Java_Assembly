...
// public.
    public static Framework app_generate_Program()
    {
        ...
        System.out.printf("started STRUCT_Class - User_Input.%n");
        stat_CLASS_get_Framework().dyn_STRUCT_get_User_Input().dyn_REG_boot1_DEFINE_User_Input(_stat_CLASS_framework);
        stat_CLASS_get_Framework().dyn_STRUCT_get_User_Input().dyn_REG_boot2_SUBSTANTIATE_User_Input(_stat_CLASS_framework);
        stat_CLASS_get_Framework().dyn_STRUCT_get_User_Input().dyn_REG_boot3_INITIALISE_User_Input(_stat_CLASS_framework);
        stat_CLASS_get_Framework().dyn_STRUCT_get_User_Input().dyn_REG_boot4_INSTANTIATE_User_Input(_stat_CLASS_framework);
        System.out.printf("done STRUCT_Class - User_Input.%n");

        System.out.printf("started STRUCT_Class - User_Output.%n");
        stat_CLASS_get_Framework().dyn_STRUCT_get_User_Output().dyn_REG_boot1_DEFINE_User_Output(_stat_CLASS_framework);
        stat_CLASS_get_Framework().dyn_STRUCT_get_User_Output().dyn_REG_boot2_SUBSTANTIATE_User_Output(_stat_CLASS_framework);
        stat_CLASS_get_Framework().dyn_STRUCT_get_User_Output().dyn_REG_boot3_INITIALISE_User_Output(_stat_CLASS_framework);
        stat_CLASS_get_Framework().dyn_STRUCT_get_User_Output().dyn_REG_boot4_INSTANTIATE_User_Output(_stat_CLASS_framework);
        System.out.printf("done STRUCT_Class - User_Output.%n");

        System.out.printf("started STRUCT_Class - User_Algorithim.%n");
        stat_CLASS_get_Framework().dyn_STRUCT_get_User_Algorithim().dyn_REG_boot1_DEFINE_User_Algorithim(_stat_CLASS_framework);
        stat_CLASS_get_Framework().dyn_STRUCT_get_User_Algorithim().dyn_REG_boot2_SUBSTANTIATE_User_Algorithim(_stat_CLASS_framework);
        stat_CLASS_get_Framework().dyn_STRUCT_get_User_Algorithim().dyn_REG_boot3_INITIALISE_User_Algorithim(_stat_CLASS_framework);
        stat_CLASS_get_Framework().dyn_STRUCT_get_User_Algorithim().dyn_REG_boot4_INSTANTIATE_User_Algorithim(_stat_CLASS_framework);
        System.out.printf("done STRUCT_Class - User_Algorithim.%n");

        System.out.printf("started STRUCT_Class - Input.%n");
        ...
        stat_CLASS_get_Framework().dyn_STRUCT_get_Input().dyn_REG_boot3_INITIALISE_Input(_stat_CLASS_framework, stat_CLASS_get_Framework().dyn_STRUCT_get_User_Input());
        stat_CLASS_get_Framework().dyn_STRUCT_get_Input().dyn_REG_boot4_INSTANTIATE_Input();
        stat_CLASS_get_Framework().dyn_STRUCT_get_Input().dyn_CLASS_get_Input_Control().SelectSetInputSubset(stat_CLASS_get_Framework().dyn_STRUCT_get_Input(), stat_CLASS_get_Framework().dyn_STRUCT_get_User_Input(), stat_CLASS_get_Framework().dyn_STRUCT_get_Input().dyn_REG_get_Input_praiseId());
        System.out.printf("done STRUCT_Class - Input.%n");

        System.out.printf("started STRUCT_Class - Output.%n");
        ...
        stat_CLASS_get_Framework().dyn_STRUCT_get_Output().dyn_REG_boot3_INITIALISE_Output(_stat_CLASS_framework, stat_CLASS_get_Framework().dyn_STRUCT_get_User_Output());
        stat_CLASS_get_Framework().dyn_STRUCT_get_Output().dyn_REG_boot4_INSTANTIATE_Output();
        stat_CLASS_get_Framework().dyn_STRUCT_get_Output().dyn_CLASS_get_Output_Control().SelectSetOutputSubset(stat_CLASS_get_Framework().dyn_STRUCT_get_Output(), stat_CLASS_get_Framework().dyn_STRUCT_get_User_Output(), stat_CLASS_get_Framework().dyn_STRUCT_get_Output().dyn_REG_get_Output_praiseId());
        System.out.printf("done STRUCT_Class - Output.%n");

        System.out.printf("started STRUCT_Class - Algorithim.%n");
        ...
        stat_CLASS_get_Framework().dyn_STRUCT_get_Algorithim().dyn_REG_boot3_INITIALISE_Algorithim(_stat_CLASS_framework, stat_CLASS_get_Framework().dyn_STRUCT_get_User_Algorithim());
        stat_CLASS_get_Framework().dyn_STRUCT_get_Algorithim().dyn_REG_boot4_INSTANTIATE_Algorithim();
        stat_CLASS_get_Framework().dyn_STRUCT_get_Algorithim().dyn_CLASS_get_Algorithim_Control().SelectSetAlgorithimSubset(stat_CLASS_get_Framework().dyn_STRUCT_get_Algorithim(), stat_CLASS_get_Framework().dyn_STRUCT_get_User_Algorithim(), stat_CLASS_get_Framework().dyn_STRUCT_get_Input().dyn_REG_get_Input_praiseId());
        System.out.printf("done STRUCT_Class - Algorithim.%n");
