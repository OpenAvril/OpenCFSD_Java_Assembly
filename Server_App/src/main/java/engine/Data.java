...
// public.
	...
	public void dyn_REG_boot1_DEFINE_Data(Framework obj)
	{
	...
	public void dyn_REG_boot4_INSTANTIATE_Data(Framework obj)
	{
		System.out.printf("entered dyn_REG_boot4_INSTANTIATE_Data().%n");
		
		System.out.printf("exiting dyn_REG_boot4_INSTANTIATE_Data().%n");
	}
