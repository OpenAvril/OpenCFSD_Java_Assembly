...
// public.
    ...
    public void dyn_REG_boot4_INSTANTIATE_Execute(int praiseId_DEFAULT)
    {
        ...
        var temp5 = ConcurrentIOServer.dyn_REG_get_ptr_PraiseEventId(_stat_PGM_ConcurrentIOServer);
        var temp6 = ConcurrentIOServer.dyn_REG_get_ptr_output_Value(_stat_PGM_ConcurrentIOServer);
        ConcurrentIOServer.dyn_REG_set_Item_input_Value_A(_stat_PGM_ConcurrentIOServer, praiseId_DEFAULT);
        ConcurrentIOServer.dyn_REG_set_Item_input_Value_B(_stat_PGM_ConcurrentIOServer, praiseId_DEFAULT);
