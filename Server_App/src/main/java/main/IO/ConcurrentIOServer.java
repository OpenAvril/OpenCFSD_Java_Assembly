...
// public.
    ...
    public static double dyn_REG_get_ptr_output_Value(Pointer obj)
    {
        try {
            return Global.stat_CONVERT_ByteArray_To_Double(JavaLIBConcurrentIOServer.INSTANCE.dyn_REG_get_ptr_output_Value(obj));
        }
        catch (NoClassDefFoundError e) {
            System.out.printf("NoClassDefFoundError.%n");
        }
    ...
    public static void dyn_REG_set_Item_input_Value_A(Pointer obj, float inputValueA)
    {
        try {
            JavaLIBConcurrentIOServer.INSTANCE.dyn_REG_set_Item_input_Value_A(obj, Global.stat_CONVERT_Float_To_ByteArray(inputValueA));
        }
        catch (NoClassDefFoundError e) {
            System.out.printf("NoClassDefFoundError.%n");
        }
    ...
    public static void dyn_REG_set_Item_input_Value_B(Pointer obj, float inputValueB)
    {
        try {
            JavaLIBConcurrentIOServer.INSTANCE.dyn_REG_set_Item_input_Value_B(obj, Global.stat_CONVERT_Float_To_ByteArray(inputValueB));
        }
        catch (NoClassDefFoundError e) {
            System.out.printf("NoClassDefFoundError.%n");
        }
