...
// public.
    ...
    {
        try {
            return Global.stat_CONVERT_ByteArray_To_boolean(JavaLIBConcurrentIOServer.INSTANCE.app_FUNCT_get_flag_isPGM_INSTNATIATED());
        }
        catch (NoClassDefFoundError e) {
            System.out.printf("NoClassDefFoundError.%n");
        }
    ...
    public static int dyn_REG_get_ptr_PraiseEventId(Pointer obj)
    {
        try {
            return Global.stat_CONVERT_ByteArray_To_int(JavaLIBConcurrentIOServer.INSTANCE.dyn_REG_get_ptr_PraiseEventId(obj));
        }
        catch (NoClassDefFoundError e) {
            System.out.printf("NoClassDefFoundError.%n");
        }
    ...
    public static double dyn_REG_get_ptr_Output_praise0_Value(Pointer obj)
    {
        try {
            return Global.stat_CONVERT_ByteArray_To_Double(JavaLIBConcurrentIOServer.INSTANCE.dyn_REG_get_ptr_Output_praise0_Value(obj));
        }
        catch (NoClassDefFoundError e) {
            System.out.printf("NoClassDefFoundError.%n");
        }
    ...
    public static void dyn_REG_set_Item_Input_praise0_Value_A(Pointer obj, float inputValueA)
    {
        try {
            JavaLIBConcurrentIOServer.INSTANCE.dyn_REG_set_Item_Input_praise0_Value_A(obj, Global.stat_CONVERT_Float_To_ByteArray(inputValueA));
        }
        catch (NoClassDefFoundError e) {
            System.out.printf("NoClassDefFoundError.%n");
        }
    ...
    public static void dyn_REG_set_Item_Input_praise0_Value_B(Pointer obj, float inputValueB)
    {
        try {
            JavaLIBConcurrentIOServer.INSTANCE.dyn_REG_set_Item_Input_praise0_Value_B(obj, Global.stat_CONVERT_Float_To_ByteArray(inputValueB));
        }
        catch (NoClassDefFoundError e) {
            System.out.printf("NoClassDefFoundError.%n");
        }
    ...
    public static void dyn_REG_set_PraiseEventId(Pointer obj, int praiseId)
    {
        try {
            JavaLIBConcurrentIOServer.INSTANCE.dyn_REG_set_PraiseEventId(obj, Global.stat_CONVERT_int_To_ByteArray(praiseId));
        }
        catch (NoClassDefFoundError e) {
            System.out.printf("NoClassDefFoundError.%n");
        }
